<template>
                ...
                <div class="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl p-6 border border-orange-100 mb-6">
                    ...
                    <div class="space-y-4">
                        <div class="bg-white rounded-lg p-4 border border-orange-200">
                            <h6 class="font-medium text-gray-800 mb-2">方法一：settings.json 配置（推荐）</h6>
                            <p class="text-gray-600 text-sm mb-4">使用 Claude Code 配置文件进行永久设置，支持全局配置和项目独立配置：</p>
                            
                            <div class="mb-4">
                                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200 mb-3">
                                    <h6 class="font-semibold text-blue-800 mb-2 flex items-center">
                                        <i class="fas fa-globe text-blue-600 mr-2"></i>
                                        1. 全局配置（系统通用）
                                    </h6>
                                    <p class="text-blue-700 text-sm mb-2">适用于所有项目的统一配置，适合默认设置场景。</p>
                                    <div class="bg-white rounded p-2 mb-2">
                                        <p class="text-gray-700 text-xs mb-1"><strong>配置文件路径：</strong></p>
                                ...
                                <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-4 border border-green-200">
                                    ...
                                    <p class="text-green-700 text-sm mb-2">用于特定项目的定制化配置，会优先于全局配置生效。</p>
                                    <div class="bg-white rounded p-2">
                                        <p class="text-gray-700 text-xs mb-1"><strong>操作步骤：</strong></p>
                                        <ol class="text-xs text-gray-600 list-decimal list-inside space-y-1">
                                            <li>在项目根目录创建 <code class="bg-gray-200 px-1 rounded">.claude\</code> 文件夹</li>
                                            <li>在该文件夹内添加 <code class="bg-gray-200 px-1 rounded">settings.json</code></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
    ...
    "apiKeyHelper": "echo '你的API密钥'"
                            ...
                            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                                ...
                                <div class="text-yellow-700 text-xs">
                                    <code class="bg-yellow-100 px-1 rounded">项目级配置(.claude\settings.json)</code> 
                                    <span class="mx-2">></span> 
                                    <code class="bg-yellow-100 px-1 rounded">全局配置(~\.claude\settings.json)</code>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white rounded-lg p-4 border border-orange-200">
                            <h6 class="font-medium text-gray-800 mb-2">方法二：PowerShell 临时设置</h6>
                            <p class="text-gray-600 text-sm mb-3">在 PowerShell 中运行以下命令：</p>
                            <div class="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm">
                                <div class="text-gray-300">$env:ANTHROPIC_BASE_URL = "{{ currentDomain }}"</div>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-orange-200">
                            <h6 class="font-medium text-gray-800 mb-2">方法三：系统环境变量（永久设置）</h6>
                            ...
                            <div class="mt-3 space-y-2">
                                <div class="bg-gray-100 p-2 rounded text-sm">
                                    ...
                                    <strong>变量值：</strong> <span class="font-mono">{{ currentDomain }}</span>
                                </div>
                                <div class="bg-gray-100 p-2 rounded text-sm">
        ...
        <div v-else-if="activeTutorialSystem === 'macos'" class="tutorial-content">
          ...
          <div class="mb-10">
              ...
              <div class="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl p-6 border border-gray-200 mb-6">
                  ...
                  <div class="mb-4">
                      <p class="text-gray-700 mb-3">方法二：使用 Homebrew</p>
                  ...
                  <div class="mb-4">
                      <p class="text-gray-700 mb-3">方法三：官网下载</p>
                      <ol class="list-decimal list-inside text-gray-600 space-y-2 ml-4">
    ...
    "apiKeyHelper": "echo '你的API密钥'"
                      ...
                      <div class="bg-white rounded-lg p-4 border border-orange-200">
                          <h6 class="font-medium text-gray-800 mb-2">方法二：临时设置（当前会话）</h6>
                          <p class="text-gray-600 text-sm mb-3">在 Terminal 中运行以下命令：</p>
                          <div class="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm">
                              <div class="text-gray-300">export ANTHROPIC_BASE_URL="{{ currentDomain }}"</div>
                      ...
                      <div class="bg-white rounded-lg p-4 border border-orange-200">
                          <h6 class="font-medium text-gray-800 mb-2">方法三：永久设置</h6>
                          ...
                          <div class="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm mb-3">
                              ...
                              <div class="text-gray-300">echo 'export ANTHROPIC_BASE_URL="{{ currentDomain }}"' >> ~/.zshrc</div>
                          ...
                          <div class="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm">
                              ...
                              <div class="text-gray-300">echo 'export ANTHROPIC_BASE_URL="{{ currentDomain }}"' >> ~/.bash_profile</div>
    ...
    "apiKeyHelper": "echo '你的API密钥'"
                      ...
                      <div class="bg-white rounded-lg p-4 border border-orange-200">
                          ...
                          <div class="bg-gray-900 text-green-400 p-3 rounded font-mono text-sm mb-3">
                              ...
                              <div class="text-gray-300">echo 'export ANTHROPIC_BASE_URL="{{ currentDomain }}"' >> ~/.bashrc</div>
